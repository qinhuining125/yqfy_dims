 ...
 */
@Controller
@RequestMapping(value = ClueFlowController.MAPPING)
public class ClueFlowController extends AbstractBaseController<ClueFlowEntity, String> {
  private static final Logger LOGGER = LoggerFactory.getLogger(ClueFlowController.class);
  public static final String MAPPING = "a/clueFlow";

  @Resource
  private ClueFlowService clueFlowService;

  @Override
  public ClueFlowService getService() {
    return clueFlowService;
  }
  ...
  public String index(Model model) {
    ...
    return "web/clueFlow/clueFlow_index";
  }
  ...
  public String edit(Model model, @RequestParam(value = "id", required = false) String id) {
    ...
    return "web/clueFlow/clueFlow_edit";
  }
  ...
  public String getDataList(@ModelAttribute CommonPageDto pageDto,
                            @ModelAttribute ClueFlowEntity dto) {
  ...
  public String saveData(@ModelAttribute ClueFlowEntity entity,
  ...
  @Override
  public void clearEntity(ClueFlowEntity entity) {
    if (null != entity) {
      entity.clean();
