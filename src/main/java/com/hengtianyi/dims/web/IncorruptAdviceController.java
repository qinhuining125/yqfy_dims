...
/**
 * IncorruptAdvice - Controller
 *
 * @author LY
 */
@Controller
@RequestMapping(value = IncorruptAdviceController.MAPPING)
public class IncorruptAdviceController extends
    AbstractBaseController<IncorruptAdviceEntity, String> {

  private static final Logger LOGGER = LoggerFactory.getLogger(IncorruptAdviceController.class);
  public static final String MAPPING = "a/incorruptAdvice";
  ...
  @Override
  public IncorruptAdviceService getService() {
    return incorruptAdviceService;
  }
  ...
  public String index(Model model) {
    ...
    return "web/incorruptAdvice/incorruptAdvice_index";
  }
  ...
  public String edit(Model model, @RequestParam(value = "id", required = false) String id) {
    IncorruptAdviceEntity entity = null;
    ...
    return "web/incorruptAdvice/incorruptAdvice_edit";
  }
  ...
  public String getDataList(@ModelAttribute CommonPageDto pageDto,
      @ModelAttribute IncorruptAdviceEntity dto) {
    try {
      ...
      List<IncorruptAdviceEntity> listData = getService().listData(queryDto);
      for (IncorruptAdviceEntity one : listData) {
  ...
  public String getDataInfo(@RequestParam String id) {
    ServiceResult<IncorruptAdviceEntity> result = new ServiceResult<>();
    IncorruptAdviceEntity one = this.getDataByIdCommon(id);
    if (null != one) {
      this.clearEntity(one);
  ...
  public String saveData(@ModelAttribute IncorruptAdviceEntity entity,
  ...
  @Override
  public void clearEntity(IncorruptAdviceEntity entity) {
    if (null != entity) {
      entity.clean();
    }
  }
