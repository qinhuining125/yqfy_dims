                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" id="queryzzDWType1" name="queryzzDWType1"
                        ...
                        <div class="col-xs-6 col-sm-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select id="queryzzDWType2" class="form-control" name="queryzzDWType2"
                                            onchange="choseZZDW2(this);">
                                        <option value="">全部</option>
                                    </select>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#btn-cx").on("click", function () {
            ...
            $.ajax({
                "url": "a/analysis/yqfkJZzzdwData.json",
                "type": "POST",
                "data": data,
                "dataType": "json",
                "cache": false,
