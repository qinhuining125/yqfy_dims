                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select name="jieZhState" class="form-control">
...
<script>
    ...
    $(document).ready(function () {
        $("#btn-cx").on("click", function () {
            ...
            $.ajax({
                "url": "a/analysis/yqfkJZzzmmData.json",
                "type": "POST",
                "data": data,
                "dataType": "json",
                "cache": false,
    ...
    function initPieData(pieData) {
        var sum = pieData.zgdy + pieData.qunzh + pieData.other
        var sumStr = "总数：" + sum
            ...
            series: [
                {
                    ...
                    radius: ['30%', '50%'],
                    data: [
                        {value: pieData.zgdy, name: '中共党员',},
                        {value: pieData.qunzh, name: '群众'},
